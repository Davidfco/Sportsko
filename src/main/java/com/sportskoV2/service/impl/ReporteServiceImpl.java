...
import com.sportskoV2.service.ReporteService;
...
public class ReporteServiceImpl implements ReporteService {
    ...
    public ResponseEntity<Resource> generaReporte(String reporte,
        ...
        try {
            ...
            //Se defiine el objeto que leer el archivo de reporte .jasper
            InputStream elReporte = fuente.getInputStream();

            //Se genera el reporte ne memoria
...
//------------A partir de aca inicia la respuesta al usuario -------------------
            ...
            switch (tipo) {
                ...
                case "Csv" -> { //Se descargar un texto tipo CSV
